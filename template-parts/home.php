...
<div class="body-left" style="width: 20%;float: left;">
		<!-- 	<?php 
						...
						<div class="block-product">	
							<div class="block-body-item" style="border:0.5px solid grey">
								<div class="block-body-item-img" style="width: 100%; height:65%;overflow: hidden; ">
									...
									<p class="block-body-button-tieu-bieu" style="margin-bottom: 5px; background: red;">
										<a href="index.php?r=cart&action=add&id=<?php echo $r['id']; ?>" style=" color: black">ĐẶT MUA</a>
									</p>
							</div>
						</div>
